...
class Publish extends React.Component {
    ...
    renderModal() {
        ...
        return (
            ...
            <Picker selectedValue={topic.tab} visible={this.state.pickerActive} 
            onValueChange={(value)=>{
        ...
        return (
            <View style={styles.publishForm}>
                ...
                <View style={[styles.publishRow,{borderBottomWidth:0}]}>
                    ...
                    <TouchableOpacity style={[styles.publishInput,styles.publishPickerInput]} onPress={this.togglePicker}>
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Header title="发布主题" onLeftButtonClick={()=>goBack(null)} rightButton="确定" onRightButtonClick={this.handleSave} userPrefs={userPrefs}/>
                {this.renderForm()}
                {this.renderModal()}
