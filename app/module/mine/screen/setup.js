...
class Setup extends React.Component {
  ...
  handleChangeTheme(nightMode) {
    ...
    let userPrefs = {
      ...
      preferredTheme: nightMode ? 'dark' : 'default'
    }
    this.setState(
      {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.setupPanel}>
          ...
          >
            ...
            <View style={[styles.setupAccessory]}>
              <View style={styles.setupComplexAccessory}>
                <Text style={[styles.setupAccessoryText]}>
        ...
        <View style={styles.setupPanel}>
          <TouchableHighlight
            style={[styles.setupRow, styles.setupSingleRow]}
            onPress={this.handleLogout}
          >
            <Text style={[styles.setupRowLabelText, { color: '#FF3300' }]}>
              切换用户
            </Text>
          </TouchableHighlight>
        </View>
