    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.setupPanel}>
          <TouchableOpacity
            style={[styles.setupRow, { borderBottomWidth: 0.5 }]}
            onPress={() => this.handleChangeFont(14)}
          >
            <View style={styles.setupRowLabel}>
              <Text style={styles.setupRowLabelText}>小</Text>
            </View>
            <View style={styles.setupAccessory}>
              <Text style={[styles.setupRowLabelText]}>
                {userPrefs['preferredFontSize'] === 14 ? (
                  <Icon name="check" size={16} color="limegreen" />
                ) : null}
              </Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.setupRow, { borderBottomWidth: 0.5 }]}
            onPress={() => this.handleChangeFont(16)}
          >
            <View style={styles.setupRowLabel}>
            ...
            <View style={styles.setupAccessory}>
              <Text style={[styles.setupRowLabelText]}>
                {userPrefs['preferredFontSize'] === 16 ? (
                  <Icon name="check" size={16} color="limegreen" />
                ) : null}
              </Text>
            </View>
          ...
          <TouchableOpacity
            style={[styles.setupRow, { borderBottomWidth: 0.5 }]}
            onPress={() => this.handleChangeFont(18)}
          >
            <View style={styles.setupRowLabel}>
            ...
            <View style={styles.setupAccessory}>
              <Text style={[styles.setupRowLabelText]}>
                {userPrefs['preferredFontSize'] === 18 ? (
                  <Icon name="check" size={16} color="limegreen" />
                ) : null}
              </Text>
            </View>
