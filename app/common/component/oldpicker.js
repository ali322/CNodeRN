...
import React,{Component,TouchableOpacity,Text,View} from "react"
...
class PickerItem extends Component{
    render(){
        const {key,selected,onValueChange} = this.props
        return (
            <TouchableOpacity key={key} style={styles.modalRow} onPress={onValueChange}>
                <Text style={[styles.modalRowText,selected?styles.modalSelectedRowText:null]}>{category.name}</Text>
            </TouchableOpacity>
        )
    }
}
